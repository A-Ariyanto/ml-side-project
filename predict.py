...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python3 predict.py <train_file> <test_file>")
        sys.exit(1)
    ...
    # REGRESSION — 4-model ensemble for safety_rating
    ...
    # CLASSIFICATION — 3-model ensemble for claim
    ...
    # EXPORT PREDICTIONS
    reg_out = f"{OUTPUT_PREFIX}_regression.csv"
    clf_out = f"{OUTPUT_PREFIX}_classification.csv"
